...
/**
 * LeasePK is the primary key class for a Lease entity.
 * @author    R. Dyer
 * @version   1.0.0 May 2002
 */
public class LeasePK implements java.io.Serializable	{
	/**
	 *	Default constructor.
	 */
	public LeasePK()	{}
	...
	/**
	 *	Constructor to build a primary key from an lease number.
	 *	@param	number	The lease number.
	 */
	public LeasePK(String number)	{
		this.number = number;
	}

	/**
	 *	Constructor to build a primary key from a another LeasePK argument.
	 *	@param	primarykey	A LeasePK object.
	 */
	public LeasePK(LeasePK primarykey)	{
	...
	public boolean equals(Object obj)	{
		return	obj instanceof LeasePK
			&&	(getNumber().equals(((LeasePK) obj).getNumber())
			);
	}
	...
	/*	Lease Entity PRIMARY KEY FIELDS ------------------------------	*/
	/** Lease number.																	*/
	private String number;
	
	
}	/*	End of Class:	LeasePK.java				*/