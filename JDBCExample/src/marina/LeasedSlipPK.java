/*
 *  @(#)LeasedSlipPK.java   1.1 2002/11/15
 *
...
/**
 * LeasedSlipPK is the primary key class for a LeasedSlip entity.
 * @author    R. Dyer
 * @version   1.0.0 May 2002
 */
public class LeasedSlipPK implements java.io.Serializable	{
	/**
	 *	Default constructor.
	 */
	public LeasedSlipPK()	{}
	 ...
	 */
	public LeasedSlipPK(String leaseNumber, String slipNumber)	{
		this(new LeasePK(leaseNumber), new SlipPK(slipNumber));
	}
	 ...
	 * @param	slipPK
	 */
	public LeasedSlipPK(LeasePK leasepk, SlipPK slippk)	{
		setLeasePK(leasepk);
		setSlipPK(slippk);
	}
	...
	/* ACCESSORS	--------------------------------------------------	*/
	public LeasePK getLeasePK()	{ return leasePK;		}
	public SlipPK getSlipPK()		{ return slipPK;		}

	
	/* MODIFIERS	--------------------------------------------------	*/
	public void setLeasePK(LeasePK pk)	{ leasePK = pk;		}
	 ...
	 */
	public String toString()	{ return	getLeasePK() + ":" + getSlipPK();		}
	...
	public boolean equals(Object obj)	{
		return	obj instanceof LeasedSlipPK
			&&	getLeasePK().equals(((LeasedSlipPK) obj).getLeasePK())
			&&	getSlipPK().equals(((LeasedSlipPK) obj).getSlipPK())
			;
	}
	 ...
	 */
	public int hashCode() {
		return	getLeasePK().hashCode() + getSlipPK().hashCode();
	}
	...
	private LeasePK leasePK;

	/** Slip number.																	*/
	private SlipPK slipPK;

}	/*	End of Class:	LeasedSlipPK.java				*/